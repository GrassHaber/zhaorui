...
<div id="content">
		...
		<div class="m-right">
			<div class="right-nav">
					<ul>
								...
								<li>></li>
								<li><a href="#">毕业生信息 : 添加毕业生学籍信息</a></li>
						</ul>
			</div>
			<div class="main">
  <form action="doAdd.jsp" method="post">
     ...
     <h2>&nbsp;添加毕业生学籍信息</h2>
     <p>&nbsp;&nbsp;毕&nbsp;业&nbsp;生&nbsp;姓&nbsp;名&nbsp;&nbsp;&nbsp;：<input type="text" name="name" required="required" autofocus="autofocus"/></p>
     <p>&nbsp;&nbsp;毕业生身份证号：<input type="text" name="number" required="required"/></p>
     <p>&nbsp;&nbsp;学&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：<input type="number" name="stunumber" required="required"></p>
     ...
     <p>&nbsp;&nbsp;所&nbsp;&nbsp;&nbsp;在&nbsp;&nbsp;&nbsp;班&nbsp;&nbsp;&nbsp;级&nbsp;：<input type="number" name="class" required="required"></p>
