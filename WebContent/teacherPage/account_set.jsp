...
<% 
	...
	String sql = "select * from user where usr='"+usr+"'";
...
%>
	...
	<form action="do_set.jsp" method="post">
	<p>&nbsp;&nbsp;用&nbsp;&nbsp;户&nbsp;&nbsp;id：<input type="number" name="id" value="${userVo.id }" readonly="readonly"/></p>
	<p>&nbsp;&nbsp;用&nbsp;&nbsp;户&nbsp;&nbsp;名：<input type="text" name="usr" value="${userVo.usr}" readonly="readonly"/></p>
