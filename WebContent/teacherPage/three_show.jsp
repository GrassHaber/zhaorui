...
<div id="content">
	<div class="left_menu">
		...
		<div class="m-right">
			...
			<div class="main">
<%
	List<ThreeVo> list = new ArrayList<ThreeVo>();
	...
	while(rs.next()){
		...
		threeVo.setStudent_id(rs.getInt("student_id"));
		threeVo.setNumber(rs.getString("number"));
		threeVo.setName(rs.getString("name"));
		threeVo.setAddress(rs.getString("address"));
		threeVo.setPerson(rs.getString("person"));
		threeVo.setPhone(rs.getString("phone"));
		threeVo.setEmail(rs.getString("email"));
		threeVo.setStyle(rs.getString("style"));
		threeVo.setPicture(rs.getString("picture"));
		threeVo.setAudit(rs.getString("audit"));
        list.add(threeVo);
	}
	request.setAttribute("list", list);
	msb.close(conn, p, rs);		
%>
	<form action="images_show.jsp" method="post">
	<p>&nbsp;&nbsp;输入毕业生id查看所上传三方协议书：<input type="number" name="student_id" required="required">
	&nbsp;&nbsp;<input type="submit" value="点击查看"></p>
	</form>
