...
<div id="content">
  ...
  %>
  <form action="do_three.jsp" enctype="multipart/form-data" onsubmit="return submit_sure()" method="post">
  <h3><b>&nbsp;&nbsp;三方协议信息--甲方（用人单位）</b></h3>
  <p>&nbsp;</p>
  <p>&nbsp;&nbsp;协议编号：<input type="number" name="number" value="<%=number%>" required="required">&nbsp;&nbsp;单位名称：<input type="text" name="name"  value="<%=name %>" required="required"/></p>
  <p>&nbsp;</p>
  <p>&nbsp;&nbsp;联&nbsp;系&nbsp;人&nbsp;：<input type="text" name="person" size="18" value="<%=person %>" required="required" />
  &nbsp;&nbsp;联系电话：<input type="number" name="phone" value="<%=phone %>" required="required"/></p>
  <p>&nbsp;</p>
  <p>&nbsp;&nbsp;单位地址：<input type="text" name="address" value="<%=address %>" size="58" required="required"/></p>
  <p>&nbsp;</p>
  ...
  <p>&nbsp;&nbsp;单位性质：<select name="style">
                      ...
                      <p>&nbsp;&nbsp;已签订三方协议照片上传（要求所盖公章齐全）：<input type="file" name="picture"></p><p>&nbsp;</p>
