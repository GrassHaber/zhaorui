...
if __name__ == '__main__':
    r = BaseRequests().get(r"http://192.168.1.64:8089/futureloan/mvc/api/member/list")
    print(r.text)
    r = BaseRequests().post(r"http://192.168.1.64:8089/futureloan/mvc/api/member/login",
